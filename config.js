...
module.exports = {
    ...
    mongoUrl: process.env.MongoDB || "mongodb+srv://darexmucheri:cMd7EoTwGglJGXwR@cluster0.uwf6z.mongodb.net/",
    sessionId: process.env.SESSION_ID || "aDNoMDJ_Queen-Anya_zaGs=",
